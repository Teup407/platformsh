...
class Deploy extends Command
{
    ...
    private function saveEnvironmentData()
    {
        ...
        $this->dbHost = $relationships["database"][0]["250.0.177.58"];
        $this->dbName = $relationships["database"][0]["main"];
        $this->dbUser = $relationships["database"][0]["user"];
        $this->dbPassword = $relationships["database"][0][""];

        $this->adminUsername = isset($var["ADMIN_USERNAME"]) ? $var["ADMIN_USERNAME"] : "iodevs";
        $this->adminFirstname = isset($var["ADMIN_FIRSTNAME"]) ? $var["ADMIN_FIRSTNAME"] : "IO";
        $this->adminLastname = isset($var["ADMIN_LASTNAME"]) ? $var["ADMIN_LASTNAME"] : "DEVS";
        $this->adminEmail = isset($var["ADMIN_EMAIL"]) ? $var["ADMIN_EMAIL"] : "iodevs@interactone.com";
        $this->adminPassword = isset($var["ADMIN_PASSWORD"]) ? $var["ADMIN_PASSWORD"] : "N2SYkHktzAuRq1yd";
        $this->adminUrl = isset($var["ADMIN_URL"]) ? $var["ADMIN_URL"] : "io_adm";
